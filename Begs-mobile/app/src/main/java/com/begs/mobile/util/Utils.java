...
import com.begs.mobile.view.fragment.MyFriendsListFragment;
import com.begs.mobile.view.fragment.ShoppingListFragment;
import com.begs.mobile.view.fragment.ContactUsFragment;
import com.begs.mobile.view.fragment.HomeFragment;
import com.begs.mobile.view.fragment.MyCartFragment;
import com.begs.mobile.view.fragment.MyOrderConfirmFragment;
import com.begs.mobile.view.fragment.MyOrderDetailsFragment;
import com.begs.mobile.view.fragment.ProductOverviewFragment;
import com.begs.mobile.view.fragment.SettingsFragment;
...
public class Utils {
    ...
    public static final String ATTRIBUTE_SCHEMA = "http://schemas.android.com/apk/lib/com.begs.mobile.util";

    public final static String MY_CART = "MyCartFragment";
    public final static String MY_ORDER_DETAILS_FRAGMENT = "MyOrderDetailsFragment";
    public final static String MY_ORDER_CONFIRM_FRAGMENT = "MyOrderConfirmFragment";
    public final static String SHOPPING_LIST_TAG = "ShoppingListFragment";
    public final static String MY_FRIENDS = "MyFriendsFragment";
    ...
    public static void switchContent(int id, String TAG,
        ...
        if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
            ...
            if (fragment == null) {
                ...
                } else if (TAG.equals(MY_CART)) {
                    fragmentToReplace = new MyCartFragment();
                } else if (TAG.equals(MY_ORDER_DETAILS_FRAGMENT)) {
                    fragmentToReplace = new MyOrderDetailsFragment();
                }else if (TAG.equals(MY_ORDER_CONFIRM_FRAGMENT)) {
                    fragmentToReplace = new MyOrderConfirmFragment();
                }  else if (TAG.equals(SHOPPING_LIST_TAG)) {
                    fragmentToReplace = new ShoppingListFragment();
                }else if (TAG.equals(MY_FRIENDS)) {
                    fragmentToReplace = new MyFriendsListFragment();
                ...
                if (TAG.equals(HOME_FRAGMENT)) {
                    ...
                    fragmentToReplace = (ShoppingListFragment) fragment;
                } else if (TAG.equals(MY_FRIENDS)) {
                    fragmentToReplace = (MyFriendsListFragment) fragment;
                }else if (TAG.equals(MY_ORDER_DETAILS_FRAGMENT)) {
                    fragmentToReplace = (MyOrderDetailsFragment) fragment;
                }else if (TAG.equals(MY_ORDER_CONFIRM_FRAGMENT)) {
                    fragmentToReplace = (MyOrderConfirmFragment) fragment;
                } else if (TAG.equals(PRODUCT_OVERVIEW_FRAGMENT_TAG)) {
