...
public class ProductDetailsFragment extends Fragment {
    ...
    private ClickableViewPager featured;
    ...
    public ProductDetailsFragment(String subcategoryKey, int productNumber,
                                  boolean isFromCart, List<Product> products) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        topSellingPager = (ClickableViewPager) rootView
                .findViewById(R.id.top_selling_pager);

        featured = (ClickableViewPager) rootView
                .findViewById(R.id.featured);
        ...
        itemTags = ((TextView) rootView.findViewById(R.id.product_tags));
        ...
        rootView.findViewById(R.id.producer_name_product_details).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Utils.switchFragmentWithAnimation(R.id.frag_container,
                                new ProducerFragment(CenterRepository.getCenterRepository()
                                        .getMapOfProductsInCategory().get(subcategoryKey).get(productListNumber).getProducer(), subcategoryKey),
    ...
    private void showRecomondation() {
        ...
        featured.setAdapter(mCustomPagerAdapter);

        featured.setOnItemClickListener(new OnItemClickListener() {
    ...
    public void fillProductData() {
        ...
        if (products != null) {
            ...
            itemName.setText(products.get(productListNumber)
                    .getItemName());

            quanitity.setText(products.get(productListNumber)
                    .getQuantity());

            itemdescription.setText(products.get(productListNumber)
                    .getItemDetail());

            String sellCostString = Money.dollars(
                    BigDecimal.valueOf(Long.valueOf(products.get(productListNumber)
                            .getSellMRP()))).toString()
                    + "  ";
            ...
            drawable = mDrawableBuilder.build(
                    String.valueOf(products.get(productListNumber).getItemName().charAt(0)),
                    mColorGenerator.getColor(products.get(productListNumber)
                            .getItemName()));

            Picasso.with(getActivity())
                    .load(products.get(productListNumber)
            ...
            label.setText(products.get(productListNumber).getDiscount());
            ...
            itemTags.setText("Tags: " + CenterRepository.getCenterRepository()
                    .getMapOfProductsInCategory().get(subcategoryKey).get(productListNumber)
                    .getTags());

            producerName.setText(CenterRepository.getCenterRepository()
                    .getMapOfProductsInCategory().get(subcategoryKey).get(productListNumber)
                    .getProducer().getProducerName());
