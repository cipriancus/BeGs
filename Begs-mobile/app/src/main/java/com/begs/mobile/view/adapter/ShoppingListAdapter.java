package com.begs.mobile.view.adapter;
...
import com.begs.mobile.view.customview.ItemTouchHelperAdapter;
import com.begs.mobile.view.customview.ItemTouchHelperViewHolder;
...
public class ShoppingListAdapter extends
    ...
    public ShoppingListAdapter(Context context,
                               OnStartDragListener dragStartListener,List<Product> products) {
        mDragStartListener = dragStartListener;

        this.context = context;

        productList = products; //FakeWebServer.getFakeWebServer().getMyShoppingList();
    }
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        holder.itemTags.setText(productList.get(position).getTags());
        ...
        holder.removeItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.valueOf(productList.get(position).getQuantity()) > 2) {
                    ...
                    productList
                            ...
                            .setQuantity(
                                    String.valueOf(
                                            ...
                                            Integer.valueOf(productList.get(position)
                                                    .getQuantity()) - 1));

                    holder.quanitity.setText(productList.get(position).getQuantity());

                    ((ECartHomeActivity) context).updateCheckOutAmount(
                            BigDecimal.valueOf(Long.valueOf(productList.get(position).getSellMRP())), false);

                    Utils.vibrate(context);
                } else if (Integer.valueOf(productList.get(position).getQuantity()) == 1) {
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder
        ...
        TextView itemName, itemTags, itemCost, availability, quanitity,
                addItem, removeItem;
        ImageView imagView;
