package com.begs.mobile.domain.api;
...
import com.begs.mobile.view.adapter.ProductsInCategoryPagerAdapter;
import com.begs.mobile.view.fragment.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        FakeWebServer.getFakeWebServer().getRecommendations();
